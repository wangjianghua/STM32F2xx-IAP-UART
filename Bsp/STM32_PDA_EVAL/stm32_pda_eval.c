/**
  ...
  *              serial EEPROM (sEE)
  *          available on STM32_PDA_EVAL evaluation board(MB786) RevA and RevB 
...
/** @defgroup STM32_PDA_EVAL_LOW_LEVEL 
  * @brief This file provides firmware functions to manage Leds, push-buttons, 
  *        COM ports, SD card on SDIO and serial EEPROM (sEE) available on 
  *        STM32_PDA_EVAL evaluation board from STMicroelectronics.
  * @{
  */ 

/** @defgroup STM32_PDA_EVAL_LOW_LEVEL_Private_TypesDefinitions
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32_PDA_EVAL_LOW_LEVEL_Private_Defines
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32_PDA_EVAL_LOW_LEVEL_Private_Macros
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32_PDA_EVAL_LOW_LEVEL_Private_Variables
  * @{
  */ 
...
/** @defgroup STM32_PDA_EVAL_LOW_LEVEL_Private_FunctionPrototypes
  * @{
  */ 
